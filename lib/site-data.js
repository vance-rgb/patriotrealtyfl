...
export const pages = {
  ...
  sell: {
    ...
    videoEmbed: {
      ...
      title: "Selling your home with Patriot Realty FL"
    },
    sections: [
      {
  ...
  "va-home-buying-florida": {
    ...
    intro: "Partner with VA-experienced Patriot Realty professionals who understand the property search, contract, appraisal, and closing considerations common to VA-backed purchases.",
    featuredVideo: {
    ...
    sections: [
      {
        ...
        body: "Patriot Realty professionals help veterans and military families search, evaluate properties, prepare competitive offers, and coordinate the real estate milestones that support a VA-backed purchase.",
        links: [
      ...
      },
      {
        ...
        links: [
          { href: "/va-home-loan-authority", label: "Visit the VA Home Loan Authority" },
